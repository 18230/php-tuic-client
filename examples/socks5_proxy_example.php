...
if (!isset($options['url'])) {
    fwrite(STDERR, <<<TXT
使用方式:
  php examples/socks5_proxy_example.php --url=https://example.com/ [options]
...
示例:
  php examples/socks5_proxy_example.php --url=http://neverssl.com/
  php examples/socks5_proxy_example.php --url=https://example.com/
  php examples/socks5_proxy_example.php --url=https://postman-echo.com/post --method=POST --data='foo=bar'

TXT);
    exit(1);
}

// 这个示例固定走本地 SOCKS5 代理，默认端口是 1080。
